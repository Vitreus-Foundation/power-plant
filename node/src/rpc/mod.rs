...
where
    ...
    C::Api: pallet_account_nonce_rpc::NonceRuntimeApi<Block, AccountId, Nonce>,
...
{
    use pallet_account_nonce_rpc::{NoncePallet, NonceApiServer};
    ...
    io.merge(NoncePallet::new(client).into_rpc())?;
