    ...
    ExtBuilder::default()
        ...
        .execute_with(|| {
            ...
            precompiles()
                ...
                .expect_cost(53148756) // 1 weight => 1 gas in mock
                .expect_log(log3(
                    ForeignAssetId(0u128),
    ...
    ExtBuilder::default()
        ...
        .execute_with(|| {
            ...
            precompiles()
                ...
                .expect_cost(73987756) // 1 weight => 1 gas in mock
                .expect_log(log3(
                    ForeignAssetId(0u128),
                    SELECTOR_LOG_TRANSFER,
                    CryptoAlith,
        ...
        .execute_with(|| {
            ...
            precompiles()
                .prepare_test(
                    CryptoAlith,
                    ForeignAssetId(0u128),
                    ForeignPCall::mint { to: Address(Bob.into()), value: 400.into() },
                )
                .execute_reverts(|output| output == b"Unknown selector");
            ...
            precompiles()
                .prepare_test(
                    CryptoAlith,
                    ForeignAssetId(0u128),
                    ForeignPCall::burn { from: Address(Bob.into()), value: 400.into() },
                )
                .execute_reverts(|output| output == b"Unknown selector");
        });
}
        ...
        .execute_with(|| {
            ...
            precompiles()
                .prepare_test(
                    CryptoAlith,
                    LocalAssetId(0u128),
                    LocalPCall::mint { to: Address(Bob.into()), value: 400.into() },
                )
            ...
            precompiles()
                .prepare_test(
                    Bob,
                    LocalAssetId(0u128),
                    LocalPCall::balance_of { who: Address(Bob.into()) },
                )
                .expect_cost(0) // TODO: Test db read/write costs
                .expect_no_logs()
                .execute_returns(U256::from(400));
        ...
        .execute_with(|| {
            ...
            precompiles()
                .prepare_test(
                    CryptoAlith,
                    LocalAssetId(0u128),
                    LocalPCall::burn { from: Address(CryptoAlith.into()), value: 400.into() },
                )
            ...
            precompiles()
                .prepare_test(
                    CryptoAlith,
                    LocalAssetId(0u128),
                    LocalPCall::balance_of { who: Address(CryptoAlith.into()) },
                )
                .expect_cost(0) // TODO: Test db read/write costs
                .expect_no_logs()
                .execute_returns(U256::from(600));
        ...
        .execute_with(|| {
            ...
            precompiles()
                .prepare_test(
                    CryptoAlith,
                    LocalAssetId(0u128),
                    LocalPCall::freeze { account: Address(Bob.into()) },
                )
                .expect_cost(20524000) // 1 weight => 1 gas in mock
                .expect_no_logs()
                .execute_returns(true);
            ...
            precompiles()
                .prepare_test(
                    Bob,
                    LocalAssetId(0u128),
                    LocalPCall::transfer { to: Address(CryptoAlith.into()), value: 400.into() },
                )
                .execute_reverts(|output| {
                    from_utf8(&output).unwrap().contains("Dispatched call failed with error: ")
        ...
        .execute_with(|| {
            ...
            precompiles()
                .prepare_test(
                    CryptoAlith,
                    LocalAssetId(0u128),
                    LocalPCall::thaw { account: Address(Bob.into()) },
                )
                .expect_cost(21026000) // 1 weight => 1 gas in mock
                .expect_no_logs()
                .execute_returns(true);
...
fn freeze_asset_local_asset() {
    ExtBuilder::default()
        ...
        .execute_with(|| {
            ...
            precompiles()
                .prepare_test(CryptoAlith, LocalAssetId(0u128), LocalPCall::freeze_asset {})
                .expect_cost(16404000) // 1 weight => 1 gas in mock
                .expect_no_logs()
                .execute_returns(true);
    ...
    ExtBuilder::default()
        ...
        .execute_with(|| {
            ...
            precompiles()
                ...
                .expect_cost(16542000) // 1 weight => 1 gas in mock
                .expect_no_logs()
                .execute_returns(true);
        ...
        .execute_with(|| {
            ...
            precompiles()
                .prepare_test(
                    CryptoAlith,
                    LocalAssetId(0u128),
                    LocalPCall::transfer_ownership { owner: Address(Bob.into()) },
                )
                .expect_cost(18129000) // 1 weight => 1 gas in mock
                .expect_no_logs()
                .execute_returns(true);
            ...
            precompiles()
                .prepare_test(
                    Bob,
                    LocalAssetId(0u128),
                    LocalPCall::transfer_ownership { owner: Address(CryptoAlith.into()) },
                )
                .expect_cost(18129000) // 1 weight => 1 gas in mock
                .expect_no_logs()
                .execute_returns(true);
    ...
    ExtBuilder::default()
        ...
        .execute_with(|| {
            ...
            precompiles()
                ...
                .expect_cost(16918000) // 1 weight => 1 gas in mock
                .expect_no_logs()
                .execute_returns(true);
    ...
    ExtBuilder::default()
        ...
        .execute_with(|| {
            ...
            precompiles()
                ...
                .expect_cost(34783476) // 1 weight => 1 gas in mock
                .expect_no_logs()
                .execute_returns(true);
...
fn clear_metadata() {
    ExtBuilder::default()
        ...
        .execute_with(|| {
            ...
            precompiles()
                .prepare_test(CryptoAlith, LocalAssetId(0u128), LocalPCall::clear_metadata {})
                .expect_cost(34100000) // 1 weight => 1 gas in mock
                .expect_no_logs()
                .execute_returns(true);
        ...
        .execute_with(|| {
            ...
            precompiles()
                .prepare_test(
                    CryptoAlith,
                    LocalAssetId(0u128),
                    LocalPCall::mint { to: Address(Bob.into()), value: U256::from(u128::MAX) + 1 },
                )
                .expect_cost(1756u64) // 1 weight => 1 gas in mock
                .expect_no_logs()
                .execute_reverts(|e| e == b"value: Value is too large for balance type");
