...
parameter_types! {
    pub LaunchPeriod: BlockNumber = prod_or_fast!(7 * DAYS, 3 * MINUTES, "VITREUS_LAUNCH_PERIOD");
    pub VotingPeriod: BlockNumber = prod_or_fast!(7 * DAYS, 3 * MINUTES, "VITREUS_VOTING_PERIOD");
    ...
    pub EnactmentPeriod: BlockNumber = prod_or_fast!(7 * DAYS, MINUTES, "VITREUS_ENACTMENT_PERIOD");
